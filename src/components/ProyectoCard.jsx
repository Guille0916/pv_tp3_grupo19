function ProyectoCard({ proyecto, onVerDetalle, onEliminar }) {
  ...
  return (
    <article className="proyecto-card">
      ...
      <div className="card-botones" style={{ marginTop: '16px', display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
        <button type="button" onClick={() => onVerDetalle(proyecto)} style={{ display: 'inline-flex', alignItems: 'center' }}>
          <svg className="boton-icono" width="16" height="16" fill="white" viewBox="0 0 24 24" aria-hidden="true" style={{ marginRight: '6px' }}>
        ...
        <button type="button" onClick={() => onEliminar(id)} style={{ display: 'inline-flex', alignItems: 'center' }}>
          <svg className="boton-icono" width="16" height="16" fill="white" viewBox="0 0 24 24" aria-hidden="true" style={{ marginRight: '6px' }}>
